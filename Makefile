...
MANDATORY = main.c
BONUS_FILE = main_bonus.c ft_check_operation.c ft_check_operation.c ft_push.c ft_reverse_rotate.c ft_filling_stack.c\
ft_error.c ft_rotate.c ft_sort_push_swap.c ft_lst_pushback.c ft_get_sort_arr.c ft_split.c ft_lst_pushfront.c ft_strlen.c\
ft_lst_create.c ft_swap.c ft_atoi.c ft_lst_del.c ft_filling_stack_utils.c ft_lst_get_len.c
